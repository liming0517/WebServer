...
import main.webapp.com.webserver_test1.core.ExceptionHttpnullException;
...
public class HttpRequest {
    ...
    //构造方法
    public HttpRequest(Socket socket) throws ExceptionHttpnullException{
    ...
    //解析请求行
    public void parseRequestLine() throws ExceptionHttpnullException{
        ...
        try {
            ...
            if(line.equals("")){
                throw new ExceptionHttpnullException();
            }
