package main.webapp.com.webserver_test2.core;
import main.webapp.com.webserver_test2.core.EmptyRequestException;
import main.webapp.com.webserver_test2.http.HttpRequest;
import main.webapp.com.webserver_test2.http.HttpResponse;
...
//            }
        ...
        //通过路径找到webapps目录下对应资源
            ...
            File file = new File("./\\src\\main\\webapp\\com\\webserver_test2\\webapps" + path);
            if (file.exists()) {
                ...
                File file404 = new File("./\\src\\main\\webapp\\com\\webserver_test2\\webapps\\myweb\\404.html");
                //设置状态码和描述
