package main.webapp.com.webserver_test2.webserver_test3.core;
import main.webapp.com.webserver_v11.core.EmptyRequestException;
import main.webapp.com.webserver_v11.http.HttpRequest;
import main.webapp.com.webserver_v11.http.HttpResponse;
import main.webapp.com.webserver_v11.servlet.RegServlet;
...
//            }
        ...
        if("/myweb/reg".equals(path)){
            ...
            File file = new File("./\\src\\main\\webapp\\com\\webserver_v11\\webapps" + path);
            if (file.exists()) {
                ...
                File file404 = new File("./\\src\\main\\webapp\\com\\webserver_v11\\webapps\\myweb\\404.html");
                //设置状态码和描述
