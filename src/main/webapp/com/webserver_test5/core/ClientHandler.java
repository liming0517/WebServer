...
import main.webapp.com.webserver_v10.core.EmptyRequestException;
import main.webapp.com.webserver_v10.http.HttpRequest;
import main.webapp.com.webserver_v10.http.HttpResponse;
...
//            }
        ...
        //通过路径找到webapps目录下对应资源
            ...
            File file = new File("./\\src\\main\\webapp\\com\\webserver_v10\\webapps" + path);
            if (file.exists()) {
                ...
                File file404 = new File("./\\src\\main\\webapp\\com\\webserver_v10\\webapps\\myweb\\404.html");
                //设置状态码和描述
